...
public class AddPointsCommand extends Command {
    ...
    public static final String MESSAGE_ADD_POINTS_SUCCESS = "Added %1$s points to %2$s";
     ...
     * @param pointsToAdd to the persons current points
     */
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        int oldPoints = personToEdit.getPoints().getValue();
        ...
        if (newPoints == Person.MAX_POINTS && oldPoints != newPoints) {
            return new CommandResult(String.format(MESSAGE_MAX_POINTS, personToEdit.getName(), Person.MAX_POINTS));
        } else {
            return new CommandResult(String.format(MESSAGE_ADD_POINTS_SUCCESS, pointsToAdd.getValue(), personToEdit.getName()));
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return name.equals(e.name) && pointsToAdd.equals(e.pointsToAdd);
    }
}